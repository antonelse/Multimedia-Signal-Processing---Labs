...
M = log2(length(alphabet)); % M è il num di bit per simbolo generico, basandosi cioè solamente sul numero degli elementi dell'alfabeto.
%Il suo limite inferiore è H, cioè l'entropia, che tiene conto anche delle prob di occorrenza dei simboli dell'alfabeto
